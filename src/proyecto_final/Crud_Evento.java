 ...
 * @author eliza
 */
public class Crud_Evento extends javax.swing.JFrame {

    /**
     * Creates new form Crud_Evento
     */
    public Crud_Evento() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Crud_Evento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Crud_Evento().setVisible(true);
            }
        });
    }
